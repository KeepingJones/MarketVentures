...
The fund holds positions across equities, FX, government bonds, corporate bonds, credit, commodities, and equity options/derivatives. Everything runs on live data. All five projects serve or depend on the same central state in `fund.db`.
...
|---|---|---|---|---|
| 1 | [price-recon](price-recon/README.md) | 8000 | **Complete** | EOD price reconciliation, break detection, Excel reports |
| 2 | [market-data-hub](market-data-hub/README.md) | 8001 | **Complete** | Data catalogue, vendor registry, quality scoring |
| 3 | [alpha-pipeline](alpha-pipeline/README.md) | 8002 | **Complete** | Signal generation, VaR, FX hedging, paper execution |
| 4 | [data-onboard](data-onboard/README.md) | 8003 | **Complete** | Vendor onboarding pipeline, OpenFIGI validation |
| 5 | [market-ops](market-ops/README.md) | 8004 | **Complete** | Unified ops dashboard, PDF stakeholder report |
...
## API keys (configured in each .env)
